...
router.post('/', async (req, res) => {
  ...
  try {
    const userWithPasswordDto = await adminService.getByUsername(userRequestDto.username);
    ...
    const token = jwt.sign({ id: userWithPasswordDto.id, role: 'ADMIN_ROLE' }, config.secret, {
